THREE.SwipeControls = function( camera, domElement ) {
	...
	this.swipeBuffer = .9; // reduction of speed after swipe is released ( between 0 and 1 )
	//this.scrollSpeed = 30;
    ...
    var leftLimit; // left limit
	var rightLimit; // right limit

	var bottomLimit; // bottom limit
	var topLimit; // top limit
	var scope = this;
    ...
    leftLimit = -3; // left limit
	rightLimit = 3; // right limit

	bottomLimit = -5; // bottom limit
	topLimit = 5; // top limit
        } else {
    leftLimit = -3.5; // left limit
	rightLimit = 3.5; // right limit

	bottomLimit = -7; // bottom limit
	topLimit = 7;
